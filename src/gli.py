...
from splitcode import text_treatment, MultiODict, count_in_list
import logging
import time
...
#1 - O Gerador Lista Invertida deverá ler um arquivo de configuração
        config = RawConfigParser(dict_type=MultiODict, strict=False)
...
#3 - Só serão usados os campos RECORDNUM, que contém identificador do texto e ABSTRACT, que contém o texto a ser classificado
        ...
        df_records["Abstract"] = text_treatment(df_records["Abstract"])
